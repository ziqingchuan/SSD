export const shortAnswer = [
    ...
    {
        question: "简述什么是软件模式？",
        answer: "软件模式是将模式的一般概念应用于软件开发领域，即软件开发的总体指导思想或参考模板",
    },
    {
        question: "简述什么是设计模式？",
    ...
    {
        question: "为什么软件系统架构需要使用不同视图来文档化？给出4种示例视图的名称和目的。",
        answer: "1. 不同视图支持不同用户与目标；\n" +
            ...
            "质量视图 Quality Views：描述了错误处理与安全性能\n",
    },
    {
        question: "简述C&C Style的本质，以SOA模式为例",
        answer: "在 SOA 模式中，组件-连接器样式的本质是通过服务（组件）的模块化和标准化接口（连接器）的解耦，实现系统的灵活集成与扩展。\n" +
            "组件：服务作为功能单元，封装业务逻辑并对外暴露接口。\n" +
            "连接器：服务绑定和通信协议作为交互规则，确保组件间协作的标准化和可扩展性。\n" +
            "核心价值：支持快速响应需求变化、降低系统复杂度，并提升服务复用率。",
    },
    {
        question: "为什么设计决策对架构很重要?说出你对“软件架构=设计原则(如，组件-连接器)+设计决策”的理解。",
        answer: "设计决策是软件架构的核心驱动力，它直接决定了系统的结构、行为、质量属性以及最终能否满足业务需求。\n" +
            "设计原则（如组件-连接器模型）是架构的“蓝图”，而设计决策是将蓝图落地为具体系统的“施工方案”",
    },
    {
        question: "描述4+1视图",
        answer: "逻辑视图：描述功能需求\n" +
    ...
    {
        question: "请分别为Module Style、C&C Style、Allocation Style列举四种视图。",
        answer: "Module Style：分解视图、泛化视图、分层视图、领域视图\n" +
            "C&C Style：管道-过滤器视图、客户端-服务器视图、面向服务视图、发布-订阅视图\n" +
            "Allocation Style：部署视图、安装视图、工作分配视图、其他分配视图\n",
    },
    {
        question: "简要描述软件架构过程中的一般活动，以及每个活动的主要输入和输出",
        answer: "① 识别ASRs：输入：无；输出：优化的质量属性场景\n" +
            "② 架构设计：输入：优化的质量属性场景、模式与战术、需求与约束；输出：候选视图的草图\n" +
    ...
    {
        question: "简述软件需求、质量属性、ASRs的区别与联系",
    ...
    {
        question: "简要描述面向服务架构 (SOA) 的基本原则，并讨论 SOA 对互操作性、可伸缩性和安全性等质量属性的影响",
        answer: "SOA的基本原则：\n" +
            "    服务契约；" +
            "    服务封装；" +
            "    服务重用；" +
    ...
    {
        question: "简述微服务架构的六大特性",
        answer: "1. 通过服务组件化\n" +
            "2. 围绕业务能力组织，而不是聚焦在技术层面\n" +
            "3. 服务内部高内聚，服务间低耦合\n" +
            "4. 去中心化\n" +
            "5. 基础设施自动化\n" +
            "6. 服务高可用性设计、演进式设计\n",
